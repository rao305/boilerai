    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="mx-auto h-12 w-12 rounded-xl" style={{ background: "#CFB991" }} />
          <h1 className="mt-3 text-3xl font-bold tracking-tight">Boiler AI</h1>
          <p className="mt-1 text-neutral-400">AI-powered academic assistant for Purdue</p>
        </div>

        <Card title={isLogin ? "Welcome back" : "Create account"}>
          <p className="-mt-2 mb-6 text-sm text-neutral-400">
            {isLogin ? "Sign in to your Boiler AI account" : "Join with your Purdue email"}
          </p>
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="mt-6 p-4 rounded-xl bg-blue-950/40 border border-blue-800/50">
            <div>
              <p className="text-sm font-medium text-blue-300 mb-3 text-center">Development Test Credentials</p>
              <div className="space-y-2 text-sm text-blue-200">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-mono text-xs">DevPassword2024!</span>
                </div>
              </div>
              <div className="mt-3 pt-2 border-t border-blue-800/30 text-center">
                <p className="text-xs text-blue-400">Quick bypass: use "/dev" as email</p>
              </div>
            </div>
          </div>
        )}
