...
class ContextualAISystem:
    ...
    def _generate_fallback_response(self, query: str, user_context: Dict[str, Any] = None) -> str:
        """Generate fallback response when main processing fails"""
        
        query_lower = query.lower()
        
        if any(word in query_lower for word in ["course", "class", "take", "schedule"]):
            return ("I'd be happy to help with course planning! To give you the most relevant advice, could you tell me "
                   "your current academic year and which courses you've completed so far? This will help me provide "
                   "specific recommendations tailored to your situation.")
        
        elif any(word in query_lower for word in ["graduate", "graduation", "timeline"]):
            return ("I can definitely help with graduation planning! Purdue CS typically takes 4 years to complete, "
                   "but there are options for early graduation or accommodating different timelines. Could you share "
                   "your current year and any specific timeline goals you have?")
        
        elif any(word in query_lower for word in ["track", "specialization", "concentration"]):
            return ("Great question about tracks! CS offers Machine Intelligence (AI/ML focus) and Software Engineering "
                   "(industry development focus) tracks. You typically choose in junior year. To help you decide, "
                   "what are your career interests or what type of work excites you most?")
        
        else:
            return ("I'm here to help with your CS academic planning! I can assist with course selection, graduation "
                   "timelines, track decisions, and academic strategy. What specific aspect of your academic journey "
