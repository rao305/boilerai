...
class CLIIntegration:
    ...
    def _get_fallback_response(self, message: str) -> str:
        ...
        if any(word in message_lower for word in ['cs 180', 'cs180', 'programming']):
            ...
            return "I'm your Boiler AI academic advisor! I can help with course planning, graduation timelines, CODO requirements, and CS track information. What would you like to know about your academic journey?"
