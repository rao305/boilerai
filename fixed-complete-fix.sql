-- Complete Supabase Fix - CORRECTED VERSION
-- Copy and paste this entire file into Supabase Dashboard > SQL Editor > Run

-- 1. Fix Storage Bucket Creation (corrected array syntax)
DELETE FROM storage.buckets WHERE id = 'transcripts';
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types, avif_autodetection)
VALUES ('transcripts', 'transcripts', false, 52428800, ARRAY['application/pdf','image/png','image/jpeg','text/plain','application/vnd.openxmlformats-officedocument.wordprocessingml.document'], false);
...
-- 6. Add sample courses if they don't exist (corrected array syntax)
INSERT INTO public.courses (course_code, title, description, credits, prerequisites, department, level) VALUES
('CS180', 'Problem Solving and Object-Oriented Programming', 'Introduction to programming and problem solving using Java.', 4, ARRAY[]::text[], 'Computer Science', 180),
('CS240', 'Programming in C', 'The C programming language, structure and style.', 3, ARRAY['CS180'], 'Computer Science', 240),
('CS250', 'Computer Architecture', 'Introduction to computer architecture and assembly language.', 4, ARRAY['CS180'], 'Computer Science', 250),
('MA161', 'Analytic Geometry and Calculus I', 'Introduction to differential and integral calculus.', 5, ARRAY[]::text[], 'Mathematics', 161),
('MA162', 'Analytic Geometry and Calculus II', 'Continuation of MA 161.', 5, ARRAY['MA161'], 'Mathematics', 162),
('PHYS172', 'Modern Mechanics', 'Introductory physics course covering mechanics.', 5, ARRAY['MA161'], 'Physics', 172)
